...
import { ArrowRight, Sparkles, Building2, Zap, Shield } from 'lucide-react';

export default function CTA() {
  const stats = [
    { value: '500+', label: 'Financial Partners', icon: Building2 },
    { value: '99.99%', label: 'API Uptime', icon: Shield },
    { value: '50ms', label: 'Response Time', icon: Zap },
    { value: '$2B+', label: 'Transactions Processed', icon: Sparkles },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Power your fintech with BankConnect's comprehensive Banking-as-a-Service platform.
                From digital wallets to lending solutions, we provide the infrastructure you need.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by leading fintech companies and digital banks
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Test all APIs free with simulated transactions
              </p>
            </div>
